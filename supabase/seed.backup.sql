...
-- Foundational seed: track-specific content, 20+ questions per track, system exams, topic summaries
\ir seed_foundational.sql

-- Starter seed: minimal functional dataset for all 4 tracks (5 systems, 10 topics, 2 guides, 20 questions, 1 deck, 20 cards, 5 high-yield, 1 practice exam per track)
\ir seed_starter.sql

-- Verification: run seed_verify.sql to confirm system counts and slugs per track
-- \ir seed_verify.sql
